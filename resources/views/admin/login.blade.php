                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="top-tabContent">
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    <form action="{{ route('admin.login') }}" method="POST" class="form-horizontal auth-form">
                                        @csrf
                                        <div class="form-group">
                                            <input required="" name="email" type="email" class="form-control" placeholder="Email Address" id="exampleInputEmail1">
                                        </div>
                                        <div class="form-group">
