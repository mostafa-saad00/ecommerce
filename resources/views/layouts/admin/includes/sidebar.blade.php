        ...
        <ul class="sidebar-menu">
            ...
            <li><a class="sidebar-header" href="#"><i data-feather="box"></i> <span>Products</span><i class="fa fa-angle-right pull-right"></i></a>
                <ul class="sidebar-submenu">
                    <li><a href="{{ route('admin.categories.list') }}"><i class="fa fa-circle"></i>Category</a></li>
            ...
            <li><a class="sidebar-header" href=""><i data-feather="chrome"></i><span>Languages</span><i class="fa fa-angle-right pull-right"></i></a>
                <ul class="sidebar-submenu">
                    <li><a href="{{ route('admin.languages.list') }}"><i class="fa fa-circle"></i>List languages</a></li>
                    <li><a href="{{ route('admin.language.create') }}"><i class="fa fa-circle"></i>Create language</a></li>
                </ul>
            </li>
